...
parser.add_argument('--action-repeat', type=int, default=4, metavar='N', help='repeat action in N frames (default: 12)')
...
class Agent():
    ...
    def load_param(self):
        weights = torch.load('model/PPO_highscore_1.pkl', weights_only=True)
